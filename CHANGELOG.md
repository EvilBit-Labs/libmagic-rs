...
- **ci**: Enable persist-credentials for signed tag pushing
- **ci**: Pin GitHub Actions to commit SHAs for supply chain security

### Refactor

- **ci**: Use mise-action instead of dtolnay/rust-toolchain
...
- Add release-plz for crates.io publishing with trusted publishing
- Add merge gate job for branch protection
