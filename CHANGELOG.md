...
- **output**: Bound and neutralize rendered descriptions, and correct the flag-walked match anchor ([#499](https://github.com/EvilBit-Labs/libmagic-rs/pull/499))

### Documentation

- **solutions**: Capture workflow-permissions validation learning ([#480](https://github.com/EvilBit-Labs/libmagic-rs/pull/480))

### Testing

- **evaluator**: Pin the use-vs-indirect result-framing contract ([#474](https://github.com/EvilBit-Labs/libmagic-rs/pull/474))
